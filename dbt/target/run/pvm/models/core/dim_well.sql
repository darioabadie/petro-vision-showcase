  ...
  insert into `analytics`.`dim_well`
        ("well_id", "well_label", "operator_raw", "area", "field", "basin", "province", "formation", "resource_type", "resource_subtype", "geojson_raw", "cota_m", "profundidad_m", "well_status", "classification", "inicio_perforacion", "fin_perforacion", "inicio_terminacion", "fin_terminacion", "first_production_month", "has_production")
